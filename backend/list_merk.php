...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">BagolStore</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            ...
            <a class="btn btn-success" href="form_merk.php" role="button">Create Jenis ATK</a>
            ...
            onclick="if(!confirm('Anda Yakin Hapus Data Merk <?=$row['nama_merk']?>?')) {return false}"
            >Delete</a>
                </td>
                    </tr>
                <?php 
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Arrahima Hamdia 2023</div>
                            <div>
