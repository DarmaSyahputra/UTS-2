    ...
    <div class="site-navbar bg-white py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="index.html" class="js-logo-clone">Paguy-store</a>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl. inkopad Raya no.12 kabupaten bogor, 16320</li>
                <li class="phone"><a href="tel://021223667">021 223 667</a></li>
                <li class="email">Paguy-store@gmail.com</li>
              </ul>
            </div>
